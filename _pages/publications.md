...
*	**Duan, Y.**, Emir, B., Bell, G. &  Cabrera, J. (2022). twopartm: Two-Part Model with Marginal Effects. <var>R package version 0.1.0.</var> [https://CRAN.R-project.org/package=twopartm](https://CRAN.R-project.org/package=twopartm)
